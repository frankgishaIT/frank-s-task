...
<table class="items">
  <thead>
    <tr><td>Item</td><td>Type</td><td class="amount">Qty</td><td class="amount">Price / Unit</td><td class="amount">Total</td></tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td class="amount">
        ...
        <?php if ($showPacking) { ?>
          <br><span style="font-size:9px; color:#8A90A3;">(<?= $packSize; ?> each = <?= (int) $item['quantity'] * $packSize; ?> <?= htmlspecialchars($item['unit'] ?? '', ENT_QUOTES, 'UTF-8'); ?>)</span>
        <?php } ?>
      </td>
