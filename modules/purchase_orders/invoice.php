...
$docNumber = 'No. PO-RM' . str_pad($po['id'], 6, '0', STR_PAD_LEFT);
...
<style>
  ...
  table.info-grid .label { color:#6B7280; width:110px; display:inline-block; margin-right:8px; }
  ...
  .sig-label { color:#1E2333; display:inline-block; width:70px; }
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <?php if ($packSize > 1) { ?>
          <br><span style="font-size:9px; color:#6B7280;">(<?= $packSize; ?> each)</span>
        <?php } ?>
      </td>
